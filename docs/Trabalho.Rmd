...
<p align = justify  style="text-indent: 3em;">Continuando nossa análise, vamos ver a idade dos atletas.</p>

```{r sumário_dados}
#| echo=TRUE
dados_agrupados_brasil |>
  group_by(idade) |> 
  summarise(idade, nome, sexo, time, noc, idade, modalidade, evento) |> 
  arrange(idade) |> 
  head(n=10) |> 
  kbl() |>
  kable_classic(
